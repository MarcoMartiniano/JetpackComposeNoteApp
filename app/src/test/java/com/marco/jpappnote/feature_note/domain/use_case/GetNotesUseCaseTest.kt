...
class GetNotesUseCaseTest{
    ...
    @Test
    fun `Order date by title descending, correct order`() = runBlocking{
    ...
    @Test
    fun `Order color by title ascending, correct order`() = runBlocking{
    ...
    @Test
    fun `Order color by title descending, correct order`() = runBlocking{
